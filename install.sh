...
ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDp+6p8PRk9JUzE9bN15QSSLRR9iUNeoDcwrz4BCrcJJ zach@MacBookAir
EOF
...
wget https://raw.githubusercontent.com/yhf971/V/main/config.json -P ~/ccminer
